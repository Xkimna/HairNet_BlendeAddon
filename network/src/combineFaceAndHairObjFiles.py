...
class CombineFaceAndHairMesh:
    ...
    def __init__(self, faceFile, hairFile):
        ...
        file = open('FaceAndHairMesh.obj', 'w')
...
if __name__ == "__main__":
    ...
    parser.add_argument('-facef','--facefile', required=True)
    parser.add_argument('-hairf','--hairfile', required=True)

    args = parser.parse_args()
    model = CombineFaceAndHairMesh(args.facefile, args.hairfile)
